let minYchange = 5; 
let maxYchange = 50;
//This range determine line overlap and width between lines
let layers = 10; // Number of layers wich are drawn
let rotStripe = 0; //rotation of each stripe; try 10 or 90;
// try lines = true with high alph or lines = false with low alph (100)
let lines = true; // The outlines
let alph = 255; //out of 255, less, the more see through it would become
...
function preload() {
  table = loadTable("atlantisColors.csv", "csv", "header");
}
